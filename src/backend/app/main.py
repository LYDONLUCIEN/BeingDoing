...
from app.api.v1 import llm_scene  # 新增：LLM 场景分流配置（chat/rumination/report 的 flash|pro + thinking）
...
app.include_router(llm_scene.router, prefix="/api/v1")  # LLM 场景分流配置（admin 读/写/恢复默认）
