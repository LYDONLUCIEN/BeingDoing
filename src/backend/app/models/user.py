...
class WorkHistory(Base):
    ...
    projects = relationship(
        "ProjectExperience", back_populates="work_history", cascade="all, delete-orphan"
    )
...
class ProjectExperience(Base):
    ...
    id = Column(String(36), primary_key=True, default=lambda: str(uuid.uuid4()))
    work_history_id = Column(
        String(36), ForeignKey("work_history.id", ondelete="CASCADE"), nullable=False
    )
