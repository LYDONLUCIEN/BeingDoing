...
export const zh = {
  ...
  home: {
    ...
    pricing: {
      title: '定价',
      subtitle: '选择适合你的激活码，开启完整的自我探索之旅',
      popular: '最受欢迎',
      quarterly: {
        name: '单人激活码',
        price: '¥69',
      ...
      free: {
        ...
        price: '免费',
        period: '/ 10轮对话',
        f1: '对话额度：10轮（基于价值观话题的交互式测评）',
        f2: '报告生成：不提供完整报告，仅输出对话过程中的即时反馈摘要',
        f3: '人工审核：不涉及',
        f4: '适用说明：用于体验产品交互形式，了解测评的基本逻辑',
        cta: '开始免费体验',
      },
      consult: {
        name: '报告解读咨询',
  ...
  payment: {
    ...
    renewal: {
      title: '延期激活',
      targetLabel: '延期目标码',
      priceHint: '延期价格按码类型：季度码 ¥23 / 3 个月，年度码 ¥33 / 1 年',
