...
export const zh = {
  ...
  dashboard: {
    ...
    reportPage: {
      ...
      statusPending: '审核中',
      statusApproved: '已生成',
      deadlineLabel: '预计完成时间',
      emptyLockedTitle: '报告尚未解锁',
      emptyLockedDesc: '完成五个探索阶段后，即可生成你的专属报告。',
      emptyLockedCta: '继续探索',
      emptyNoneTitle: '暂无报告',
      emptyNoneDesc: '激活或购买完整码，完成探索后即可生成专属报告。',
      emptyNoneCta: '查看我的激活码',
    },
    codeType: {
      trial: '试用',
      full: '完整',
