...
export const en = {
  ...
  home: {
    ...
    pricing: {
      title: 'Pricing',
      subtitle: 'Choose a plan to unlock your full self-exploration journey',
      ...
      annual: {
        ...
        f2: '3 personal reports + manual review',
  ...
  dashboard: {
    ...
    purchaseCard: {
      ...
      desc: 'Choose a plan to unlock all phases and your personal reports',
      quarterly: 'Quarterly',
      annual: 'Annual',
      popular: 'Most Popular',
      buy: 'Buy Now',
