...
export const en = {
  ...
  home: {
    ...
    reportCard: {
      ...
      item1: 'Customized perspective: ::deep interpretation of your values, strengths, passions, and purpose, with career development recommendations;',
      item2: 'Minimal action guides: ::clear psychological and practical barriers, breaking through "not daring to start" and "hard to keep going";',
      item3: 'Clear development path: ::both the starting point and the destination are marked, so every step is taken with confidence;',
      item4: 'Precise decision support: ::for key pain points in career scenarios;',
      item5: 'Risk foresight: ::proactive countermeasures and backup plans for potential career risks;',
      item6: 'Honest self-knowledge: ::know yourself objectively and turn your strengths into lasting competitiveness.',
      cta: 'Start Exploring',
      previewCaption: 'Report Content Preview',
      previewAlt1: 'Report content overview page',
      previewAlt2: 'Passion analysis chapter preview',
      previewAlt3: 'Final choice chapter preview',
    },
  ...
  explore: {
    ...
    chat: {
      ...
      /** “Complete & Continue” confirmation modal (first four steps; the step locks once you move on) */
      continueConfirmTitle: 'Confirm before moving on',
      continueConfirmMessage:
        'Once you continue, this step\'s conversations and conclusion card will be locked and cannot be edited.\nIf you are not sure about this round yet, click “New chat” on the left to keep exploring.',
      continueConfirmOk: 'Confirm & continue',
      continueConfirmCancel: 'Let me think again',
    ...
    report: {
      ...
      reviewPendingDesc: 'Your report is being reviewed. It will be unlocked 24 hours after submission, and you will be notified via in-app message.',
  ...
  payment: {
    ...
    plan: {
      ...
      annual_package: {
        ...
        f4: 'Team analysis',
        f5: '1 free report recheck',
      },
    },
    dialog: {
      title: 'Give Your Exploration More Possibilities',
      months: '{count} months',
      subtitleQuarterly: 'Spend a quarter exploring who you are right now',
      subtitleAnnual: 'Spend a year getting to know yourself, continuously',
      descQuarterly: 'Deep exploration by phase, ideal for short-term goals',
      descAnnual: 'A full year of ongoing self-discovery',
      benefitChatTitle: 'Unlimited AI deep conversations',
      benefitChatSub: 'Ask anytime, explore deeper',
      benefitReviewTitle: 'Manual report review',
      benefitReviewSub: 'Professional quality assurance',
      benefitReportTitle: '{count} full exploration report(s)',
      benefitReportSub: 'See yourself across dimensions',
      benefitRenewalTitle: '7-day free renewal',
      benefitRenewalSub: 'A little more time to explore',
      benefitTeamTitle: 'Team matching & role analysis',
      benefitTeamSub: 'Discover your unique value in a team',
      compareTitle: 'Feature Comparison',
      compareExpand: 'Expand',
      compareCollapse: 'Collapse',
      compareFootnote: 'After the quarterly/annual plan expires, reports remain viewable; conversations cannot be edited or viewed.',
      selectedLabel: 'Selected',
      confirm: 'Confirm Purchase',
    },
    compare: {
      colFeature: 'Feature',
      quota: 'AI conversation quota',
      quotaValue: 'Unlimited',
      reports: 'Full report (30+ pages / 7+ themes)',
      reportsQuarterly: '1 report',
      reportsAnnual: '3 reports',
      review: 'Manual report review',
      team: 'Team matching & role analysis',
      renewal: '7-day free renewal',
      duration: 'Validity period',
      durationQuarterly: '3 months',
      durationAnnual: '12 months',
      scene: 'Best for',
      sceneQuarterly: 'Quarterly self-awareness iterations, or deep exploration of specific issues',
      sceneAnnual: 'Personal periodic reviews, team formation, collaboration diagnostics and cross-member analysis',
    },
    renewal: {
    ...
    coupon: {
      ...
      myCoupons: 'My available coupons',
      myCouponsPlaceholder: 'Select one of my coupons',
  ...
  consultation: {
    ...
    listTitle: 'My Consultation Bookings',
    listSubtitle: 'Click a booking to fill in the questionnaire or check progress',
    listEmpty: 'No consultation bookings yet',
    listEmptyHint: 'Bookings will appear here after you purchase a report consultation',
    goOrders: 'Go to My Orders',
    statusPendingSurvey: 'Questionnaire pending',
