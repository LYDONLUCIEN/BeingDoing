        ...
        {managing ? (
          ...
          <>
            ...
            <button
              ...
              onClick={enterDraft}
              className="new-btn flex h-9 items-center gap-2 rounded-full px-3.5 text-[12px] font-semibold text-white transition-all hover:scale-[0.98] disabled:opacity-50"
              style={{
                background: 'var(--journey-ink,#17212d)',
